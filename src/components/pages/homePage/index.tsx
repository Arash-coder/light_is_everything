        ...
        <section className=" w-full bg-background">
          <div className="relative custom_container">
            ...
            <div className="text-light text-justify text-last text-align-last-center font-aria_regular text-lg md:text-xl mt-8">
              او در سحرگاهان به پنجره‌های دل‌ها می‌زند و به زندگی تازگی می‌بخشد.
              نور، آفتابی است که خنده‌ای به شب تلخ عشق می‌دهد و نقاب تاریکی را
              از روی چهره زمین برمی‌دارد و در هر آستانه‌ای که قدم می‌گذارد،
              رنگ‌های زندگی را پاکی و شفافیت می‌بخشد نور، هنرمندی است که با هر
              جزئی از طبیعت به گفتن داستانی جدید می‌پردازد. او در پرتوهای
              خورشید، لوحی را بر روی آسمان نقاشی می کند و در خمیدن برگ‌ها،
              حکایتی از زمین می‌خواند. با هر لمس خورشید به دریا، او چشمان آبی
              آسمان را به ترانه‌های دریا می‌بندد و با نوری که از ابرها فرو
              می‌چکد، قصه‌ای از آب و هوا می‌سراید. هرچه آن را بیشتر می‌شناسیم،
              نور را بهتر درک می‌کنیم. او نه تنها منشأ روشنایی است، بلکه نمادی
              از امید و روح است. نور، با وجود هرچه زیبا و زاویه‌های مختلفی که به
              او نگاه کنیم، همواره معنایی ناب و جذاب در خود جای دارد. او همیشه
              در حال تحول است و با هر طول موجی که دارد، داستانی تازه و مافوق
              العاده برای ما می‌نویسد. در پناه سایه‌های نور، احساس آرامش و امنیت
              را تجربه کنید. نور، بی‌کلام و با صدایی بی‌صدا، زبان عاشقانه‌ای است
              که در هر قطره از وجودش، حکایتی از زندگی و زیبایی را برایمان رقم
              میزند این تازه اول داستان ما خواهد بود ... به خانواده ما, خانواده
              نور خوش آمدید
            </div>
          </div>
          ...
          <div className="relative">
            <div className="custom_container flex flex-col items-center text-justify text-align-last-center p-3 !max-w-md">
              ...
              <p className="font-aria_normal text-lg md:text-2xl mt-8">
                ما با افتخار مجموعه‌ای از محصولاتی را به شما ارائه می‌دیم که نه
                تنها از نظر کیفی ،بلکه به لحاظ معنوی دارای ارزش بالایی برای ما
                هستن هر یک از این محصولات ، با نگاهی به نیاز های خانواده نور
                تولید شدن. گرچه اونها بهانه ای برای شباهت بیشتر ظاهری این
                خانواده هستن اما باتوجه به کیفیت مطلوب اونها به لحاظ متریال و
                دیزاین, آماده ارائه به تمام عزیزان و اقشار مختلف هستن اما در
                پروسه تولید این محصولات فقط کیفیت هدف ما نبوده .
              </p>
