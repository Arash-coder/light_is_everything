...
const Accountgallery = (props: Props) => {
  return <div className='grow mb-20'>
    ...
    <div className='font-aria_sbold'>
      ...
      <div>
        <div className='grid grid-cols-2 gap-x-3 gap-y-6 justify-stretch items-stretch '>
            ...
            <div className='mb-6'>
              <Upload placeholderComponent={
                <div className='py-5 flex flex-col items-center justify-center '>
                  ...
                  <div className='text-neutral-400'>توجه! فرم بارگزاری تصویر JPEG باشد </div>
          ...
          <div className='col-span-2 md:col-span-1 '>
            <InputArea rows={10} label='توضیح اثر *' placeholder='توضیح اثر' />
          </div>
          <div className='col-span-2 flex gap-3 justify-between items-end'>

            <div className='grow'>
              <Input className='grow' label='تگ های مرتبط با تصویر (هر تگ را با فاصله جدا کنید)' placeholder='مثال: فتوشاپ  پاییز  شب  پرتره' />
            </div>
        ...
        <Table scroll={{ x: 400 }} pagination={{
          pageSize: 5
        }} className='noxTable noxPagination w-full' dataSource={dataSource} columns={columns} />
      </div>
    </div>
  </div>;
};
...
const columns: any = [
  {
    ...
    align: 'center',
    render(val: any) {
      return <Image src={profile} alt='profile' className='w-16 h-16 m-auto object-contain' />
    },
    width: 100
  },
  {
